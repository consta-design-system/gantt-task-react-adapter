...
const cnGantTaskReactAdapterFullyExample = cn('GantTaskReactAdapterFullyExample')
...
const views = [ViewMode.Day, ViewMode.HalfDay, ViewMode.Month, ViewMode.QuarterDay, ViewMode.Week]
